...
], columns=["Species", "h10", "h11", "h12", "h20", "h21", "h22", "g10", "g11", "g12", "g20", "g21", "g22", "v30", "v31", "v32", "CDh", "CDg", "CDv"])

# Parameters for the Nat2 model
_PARAMS_NAT2 = pd.DataFrame([
...
], columns=["Species", "v10", "v11", "v12", "v20", "v21", "v22", "Cd"])
...
def Ung2009(
    ...
    pandas.DataFrame
        ...
        - V2 (if Nat2 is used): Predicted volume (m³/ha) based on the Nat2 model
    ...
    if len(param) == 0 or len(param2) == 0:
        raise ValueError("Invalid species. Please provide a valid species name.")
